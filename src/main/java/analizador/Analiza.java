	...
	{	
		...
		try{
			...
			while (linea != null){
				...
				System.out.println("Linea8: "+linea);
				tokenizer = new StringTokenizer(linea);System.out.println("Linea9(paso por tokenizer):"+linea);
				while(tokenizer.hasMoreTokens()) //DENTRO DE ESTE WHILE, EN EL METODO analizadorLexico SE MANDA CADA TOKEN, CADA PALABRA
				{				
					columna++;
					token = tokenizer.nextToken();
					System.out.println("Token10: " + token);
...
//		System.out.println(cont++ + " " +token);
	...
	public String espacios(String linea){
		...
		{System.out.println("Linea3: " + linea);
		System.out.println("LineaCadena: " + cadena);
			if(linea.contains(cadena)) {System.out.println("Linea4: " + linea);
				linea = linea.replace(cadena, " "+cadena+" ");System.out.println("Linea5: " + linea);
			}System.out.println("Linea6: " + linea);
		}System.out.println("Linea7: " + linea);
		return linea;
	}
