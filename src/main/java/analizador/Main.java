		...
		if (a1.get(0).equals("No hay errores lexicos")) {
			...
			System.out.println("----------IMPRIME TOKENRC---------------");{
				for (int i = 0; i < analizador.tokenRC.size(); i++) {
					System.out.println(analizador.tokenRC.get(i).getColumna());
					System.out.println(analizador.tokenRC.get(i).getRenglon());
					System.out.println(analizador.tokenRC.get(i).getTipo());
